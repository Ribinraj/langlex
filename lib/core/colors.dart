...
class Appcolors {
  // static const kwhite = Color(0xFFF6F6F6);
  // static const kwhitelight = Color(0xFFFFFFFF);
  ...
  static const kpurplecolor = Color.fromARGB(255, 177, 115, 240);
  static const kredcolor = Colors.red;
  // static const korangeColor = Color.fromARGB(255, 243, 139, 21);

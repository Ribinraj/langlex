...
//////////////////////////////////
class ScreenLanguagePage extends StatefulWidget {
  final List<LanguageModel2> selectedLanguages;
  const ScreenLanguagePage({super.key, required this.selectedLanguages});
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              height: 4,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 107, 197, 172)
                                    .withOpacity(0.3), // kgreenlightColor
                                borderRadius: BorderRadius.circular(2),
                              ),
                            ),
                                      ...
                                      onTap: () async {
                                        ...
                                        await prefs.setInt(
                                            ...
                                            widget.selectedLanguages[index]
                                                .languageId);
                                        log( 'selectedlanguage  ${widget.selectedLanguages[index]
                                                .languageName}');
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          gradient: isSelected
                                              ? const LinearGradient(
                                                  colors: [
                                                    Color.fromARGB(255, 71, 158,
                                                        133), // kgreenColor
                                                    Color.fromARGB(
                                                        255,
                                                        107,
                                                        197,
                                                        172), // kgreenlightColor
                                                  ],
                                                  begin: Alignment.topLeft,
                                                  end: Alignment.bottomRight,
                                                )

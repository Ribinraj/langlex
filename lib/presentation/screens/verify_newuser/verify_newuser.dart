...
// class ScreenNewuserVerification extends StatefulWidget {
//   final String mobileNumber;
//   final String customerId;

//   const ScreenNewuserVerification({
//     super.key,
...
//   @override
//   State<ScreenNewuserVerification> createState() =>
//       _ScreenNewuserVerificationState();
// }

// class _ScreenNewuserVerificationState extends State<ScreenNewuserVerification>
...
//                               FadeTransition(
//                                 opacity: _fadeAnimation,
//                                 child: BlocConsumer<VerifyUserBloc,
//                                     VerifyUserState>(
...
//                                         context,
//                                         const ScreenStudentRegistration(),
//                                       );
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              FadeTransition(
                                opacity: _fadeAnimation,
                                child: BlocConsumer<UserRegisterBloc,
                                    UserRegisterState>(
                                  listener: (context, state) {
                                    if (state is UserRegisterSuccessState) {
                                      CustomNavigation
                                          .pushReplaceWithTransition(
                                        context,
                                         ScreenOtpVerification(mobileNumber:widget.mobileNumber , customerId:state.userId),
                                      );
                                    } else if (state
